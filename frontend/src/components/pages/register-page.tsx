...
const registerSchema = z.object({
  ...
  preferredTimezone: z.string().min(6, "Preferred Timezone is required"),
});
...
export const Register = () => {
  ...
  useEffect(() => {
    ...
    setValue("preferredTimezone", timezone);
  }, [setValue]);
    ...
    <div className="flex flex-col justify-center items-center h-[100vh] ">
      ...
      <form className="mt-10 w-[20%]" onSubmit={handleSubmit(onSubmit)}>
        <div className="relative z-0 w-full mb-5 group">
          ...
          <label className="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-8 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto peer-focus:text-secondary peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-8 flex items-center gap-2">
            <svg
        ...
        <input type="hidden" {...register("preferredTimezone")} />
